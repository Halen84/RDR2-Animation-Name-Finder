...
namespace RDR2AnimationNameFinder
{
	partial class HelpForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Why can I only look for .sys files?";
			// 
			// label2
			// 
			...
			this.label2.Text = "Right now, using .sys files is the only way to actually find animation names";
			// 
			// label3
			// 
			...
			this.label3.Text = "How do I get/find .sys files?";
			// 
			// label4
			// 
			...
			this.label4.Text = "You have to select a dictionary via OpenIV > Right Click > Save content/Export\r\n";
			// 
			// label5
			// 
			...
			this.label5.Text = "What is a dictionary?";
			// 
			// label6
			// 
			...
			this.label6.Text = "In this case, a dictionary is basically a file that contains lots of animations c" +
    "ompressed into 1 big file";
			// 
			// label7
			// 
